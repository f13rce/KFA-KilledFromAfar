...
subdirh = "data/messages/"
subdircpp = "data/messages/"
log = open(path + "codegen_log.txt",'w')
...
def StartHeaderFile():
    ...
    h.write("/* For more info, find protocol.txt / codegen.py or contact f13rce#1313 */\n\n")
    ...
    h.write(tab + "Message::~Message();\n")
    h.write(newline)
    h.write(tab + "virtual void Serialize(Net13::DataStreamWriter& aWriter){}\n")
    h.write(tab + "virtual void Deserialize(Net13::DataStreamReader& aReader){}\n")
...
def StartSourceFile():
    ...
    cpp.write("#include \"data\\messages\\NetcodeMessages.h\"\n")
    cpp.write(newline)
    cpp.write("namespace Net13\n")
    cpp.write("{\n")
...
def StartMessage(messageName, opcode):
    ...
    h.write(newline)    
    h.write(tab + "void Serialize(Net13::DataStreamWriter& aWriter);\n")
    h.write(tab + "void Deserialize(Net13::DataStreamReader& aReader);\n")
...
def EndMessage(messageName, opcode):
    ...
    cpp.write("void " + messageName + "::Serialize(Net13::DataStreamWriter& aWriter)\n")
    cpp.write("{\n")
    ...
    cpp.write("void " + messageName + "::Deserialize(Net13::DataStreamReader& aReader)\n")
    cpp.write("{\n")
...
cpp = open(path + subdircpp + 'NetcodeMessages.cpp','w+')
Log("Opening h file")
h = open(path + subdirh + 'NetcodeMessages.h','w+')

def main():
    Log("Truncating output files")
    cpp.truncate()
    h.truncate()

    global messageOpcode
    global stringLines
    global stringPreLines
