...
uint8_t Net13::Connection::GetPacketCount() const
{
...
void Net13::Connection::PushPing(uint32_t aPing)
{
	// Validate ping
...
const uint32_t Net13::Connection::GetNewestPing() const
{
	return m_RecentPings[0];
}

const uint32_t Net13::Connection::GetAveragePing() const
{
...
bool Net13::Connection::SequenceIsNewer(uint8_t aID) const
{
